...
var start = function() {
    ...
    blocks.forEach(function(block) {
        ...
        var blockInfo = {
            ...
            westFees: block.westFees,
            previousBlockWestFees: block.previousBlockWestFees,
...
var getAllBlocks = function() {
    sleep.msleep(1000);
    // Here, you can enter the height of the first block your node received a lease!
    var firstBlockWithLeasesForNode = 734000
    var currentStartBlock = firstBlockWithLeasesForNode;
    var blocks = [];
    var steps = 100;
...
/**
 * This method distributes either West fees..
 *
 * @param activeLeases active leases for the block in question
 * @param amountTotalLeased total amount of leased West in this particular block
...
var distribute = function(activeLeases, amountTotalLeased, block, previousBlock) {
   ...
   fee = block.westFees * 0.4 + block.previousBlockWestFees * 0.6;
 ...
 * of leased West for a given block.
 *
 * @param block the block to consider
 * @returns {{totalLeased: number, activeLeases: {}}} total amount of leased West and active leases for the given block
 */
